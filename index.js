    ...
    danta.ev.on('group-participants.update', async (anu) => {
        ...
        try {
            ...
            for (let num of participants) {
                ...
                if (anu.action == 'add') {
                  danta.sendMessage(anu.id, { image: { url: pp_user }, contextInfo: { mentionedJid: [num] }, caption: `╭━═════════════━• \n│〘Halo @${num.split("@")[0]}〙\n╰━═════════════━• \n╭━═════════════━• \n│⭔ Welcome To\n│⭔ ${metadata.subject}\n╰━═════════════━• \n╭━═════════════━• \n│⭔ 𝑫𝑨𝑵𝑻𝑨 𝑫𝑬𝑽\n╰━═════════════━• \n •━══〘𝑫𝒂𝒏𝒕𝒂 𝑫𝒆𝒗〙══━•` })
                    
                } else if (anu.action == 'remove') {
                  danta.sendMessage(anu.id, { image: { url: pp_user }, contextInfo: { mentionedJid: [num] }, caption: `╭━═════════════━• \n│〘Bye @${num.split("@")[0]}〙 \n╰━═════════════━• \n╭━═════════════━• \n│⭔ Leaving From\n│⭔ ${metadata.subject}\n╰━═════════════━• \n╭━═════════════━• \n│⭔ 𝑫𝑨𝑵𝑻𝑨 𝑫𝑬𝑽\n╰━═════════════━• \n •━══〘𝑫𝒂𝒏𝒕𝒂 𝑫𝒆𝒗〙══━•` })
                } else if (anu.action == 'promote') {
                    danta.sendMessage(anu.id, { image: { url: ppuser }, mentions: [num], caption: `@${num.split('@')[0]} Terima Kasih Telah Di Jadikan Admin ${metadata.subject}` })
                } else if (anu.action == 'demote') {
                    danta.sendMessage(anu.id, { image: { url: ppuser }, mentions: [num], caption: `Maaf @${num.split('@')[0]} Anda Diberhentikan Menjadi Admin ${metadata.subject}` })
              }
            }
        } catch (err) {
            console.log(err)
